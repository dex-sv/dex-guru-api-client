...
T = TypeVar("T", bound="BodyGetTokensByParamsPostV3TokensPost")


@attr.s(auto_attribs=True)
class BodyGetTokensByParamsPostV3TokensPost:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        body_get_tokens_by_params_post_v3_tokens_post = cls(
            amm=amm,
            sort_by=sort_by,
            order=order,
        ...
        body_get_tokens_by_params_post_v3_tokens_post.additional_properties = d
        return body_get_tokens_by_params_post_v3_tokens_post
