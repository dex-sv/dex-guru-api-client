...
T = TypeVar("T", bound="RestBurnModel")
...
class RestBurnModel:
    ...
    Attributes:
        ...
        transaction_type (Union[Unset, TransactionChoices]): An enumeration. Default: TransactionChoices.BURN.
    """
    ...
    transaction_type: Union[Unset, TransactionChoices] = TransactionChoices.BURN
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rest_burn_model.additional_properties = d
        return rest_burn_model
