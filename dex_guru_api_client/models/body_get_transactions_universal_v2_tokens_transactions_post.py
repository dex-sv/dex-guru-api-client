...
T = TypeVar("T", bound="BodyGetTransactionsUniversalV2TokensTransactionsPost")


@attr.s(auto_attribs=True)
class BodyGetTransactionsUniversalV2TokensTransactionsPost:
    """
    Attributes:
        transaction_type (Union[Unset, List[TransactionChoices]]):
        amm (Union[Unset, AmmChoices]): An enumeration.
        token_address (Union[Unset, str]): Token Address
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        body_get_transactions_universal_v2_tokens_transactions_post = cls(
        ...
        body_get_transactions_universal_v2_tokens_transactions_post.additional_properties = d
        return body_get_transactions_universal_v2_tokens_transactions_post
