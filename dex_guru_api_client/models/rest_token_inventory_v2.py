...
T = TypeVar("T", bound="RestTokenInventoryV2")


@attr.s(auto_attribs=True)
class RestTokenInventoryV2:
    """
    Attributes:
        id (Union[Unset, str]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rest_token_inventory_v2.additional_properties = d
        return rest_token_inventory_v2
