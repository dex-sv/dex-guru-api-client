...
def _get_kwargs(
    ...
    *,
    ...
    currency: Union[Unset, None, str] = "USD",
    interval: Union[Unset, None, Periods] = Periods.DAY,
    amms: Union[Unset, None, str] = [],
) -> Dict[str, Any]:
    url = "{}/v1/tokens/{token_id}/history".format(client.base_url, token_id=token_id)
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        currency (Union[Unset, None, str]): Currency Default: 'USD'.
        interval (Union[Unset, None, Periods]): An enumeration. Default: Periods.DAY.
