...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/v1/tokens/{token_id}".format(client.base_url, token_id=token_id)
...
) -> Optional[Union[HTTPValidationError, RestTokenInventoryV1]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = RestTokenInventoryV1.from_dict(response.json())
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[HTTPValidationError, RestTokenInventoryV1]]:
    return Response(
