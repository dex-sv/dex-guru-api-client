...
from ...models.rest_tokens_last import RestTokensLast
...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/v2/tokens/{token_id}/last".format(client.base_url, token_id=token_id)
...
) -> Optional[Union[HTTPValidationError, RestTokensLast]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = RestTokensLast.from_dict(response.json())
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[HTTPValidationError, RestTokensLast]]:
    return Response(
