...
from ...models.rest_tokens_history_v3 import RestTokensHistoryV3
...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/v3/tokens/{token_id}/history".format(client.base_url, token_id=token_id)
...
) -> Optional[Union[HTTPValidationError, RestTokensHistoryV3]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = RestTokensHistoryV3.from_dict(response.json())
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[HTTPValidationError, RestTokensHistoryV3]]:
    return Response(
