...
from ...models.body_get_last_transactions_v3_tokens_transactions_last_post import (
...
def _get_kwargs(
    *,
    client: Client,
    json_body: BodyGetLastTransactionsV3TokensTransactionsLastPost,
) -> Dict[str, Any]:
    url = "{}/v3/tokens/transactions/last".format(client.base_url)
